...
(function (jQuery) {
	...
	var Behavior = function (div, opts) {
		...
		function apply() {
            ...
            // if (opts.behavior.draggable) { 
            // 	bindDrag(div, opts.cellWidth, opts.start, opts.behavior.onDrag); 
        	// }
		}
        ...
        // function bindDrag(div, cellWidth, startDate, callback) {
        // 	jQuery("div.ganttview-block", div).draggable({
        // 		axis: "y", 
        // 		grid: [cellWidth, cellWidth],
        // 		stop: function () {
        // 			var block = jQuery(this);
        // 			updateDataAndPosition(div, block, cellHeight, startDate);
        // 			if (callback) { callback(block.data("block-data")); }
        // 		}
        // 	});
        // }
    ...
    var DateUtils = {
        ...
        daysBetween: function (start, end) {
            ...
            if (start.getYear() == 1901 || end.getYear() == 2022) { return 0; }
